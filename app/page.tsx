      ...
      <section className="how-section">
        ...
        <div className="how-steps">
          ...
          <div className="how-step">
            ...
            <span className="how-step-time">Days 2–3</span>
          </div>
          <div className="how-step">
            ...
            <span className="how-step-time">Day 3</span>
          </div>
        </div>
          ...
          <div className="about-grid">
            <div className="about-left-col">
              ...
              <div className="about-stats-row">
                <div>
                  <span className="stat-number pink">2–3</span>
            ...
            <div className="about-right-col">
              ...
              <div className="about-right">
                ...
                <p className="about-body">
                  I&apos;m a self-taught web designer based in London. I build websites that look good and actually do something — convert visitors, generate bookings, build trust.
                </p>
                <p className="about-body">
